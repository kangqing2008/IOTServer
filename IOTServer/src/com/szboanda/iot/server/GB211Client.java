...
//			}
	...
	private static class ClientTesterHandler extends SimpleChannelInboundHandler<ByteBuf>{
		...
		protected void channelRead0(ChannelHandlerContext ctx, ByteBuf msg) throws Exception {
			System.out.println("Client " + ManagementFactory.getRuntimeMXBean().getName().split("@")[0] 
					+ " " + Thread.currentThread().getId() + " read:" + ByteBufUtil.hexDump(msg.readBytes(msg.readableBytes())));
		}
